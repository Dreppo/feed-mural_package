...
class FeedRepositoryImpl implements FeedRepository {
  ...
  @override
  Future<void> dislikePost(LikeModel like) async => await supabase
      .from('liked')
      .delete()
      .eq('fk_post_id', like.postId)
      .eq('fk_user_id', like.userId);
  ...
  Future<List<FeedModel>> findSavedPosts(int userId) async =>
      ...
      )).map<FeedModel>((post) => FeedModel.fromJson(post)).toList();
